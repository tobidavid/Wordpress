<nav id="quadmenu" class="<?php echo esc_attr($args->navbar_class); ?> quadmenu-is-vertical" data-template="inherit" data-theme="<?php echo esc_attr($args->theme); ?>" data-unwrap="<?php echo esc_attr($args->unwrap); ?>" >
