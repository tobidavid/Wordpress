...
class Widget_FD_Elementor_Button_plus extends Widget_Base {
    ...
    protected function _content_template() {  //this part increase the performing speed of advanced button element.
        ...
        <div class="single-button-wrapper">
            ...
            <# } #>
            <# if ( settings.fd_adv_btn1_layout == 'sketch' ) { #>
                <a class="elementor-button elementor-size-{{ settings.fd_adv_btn1_size }} single-button-{{ settings.fd_adv_btn1_layout }} {{ hover_animation }}" href="{{ settings.fd_adv_btn1_link.url }}" {{link_type}}>
            <# } #>
