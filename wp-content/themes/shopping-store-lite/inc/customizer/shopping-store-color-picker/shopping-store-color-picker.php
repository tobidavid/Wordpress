 ...
 */
class Shopping_Store_Customize_Opacity_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'shopping-store-color-picker',
			get_template_directory_uri() . '/inc/customizer/shopping-store-color-picker/shopping-store-color-picker.js',
		...
		wp_enqueue_style(
			'shopping-store-color-picker',
			get_template_directory_uri() . '/inc/customizer/shopping-store-color-picker/shopping-store-color-picker.css',
